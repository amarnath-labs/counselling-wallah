  ...
  new Map([
    [
      ...
      ),
      {
        branchId: '139',
        dbBranch:
          'Space Science and Engineering (4 Years, Bachelor of Technology)',
      },
    ],
...
for (
  ...
  if (alias) {
    ...
    plan.push({
      ...
      reason:
        'Preserve distinct 2024 historical program identity; no safe alias approved.',
    });
  }
}
...
console.log(
  'JOSAA 2024 BRANCH RESOLUTION PLAN'
);
