...
const INPUT = "./josaa-fee-batch-03-ready.json";
const SAFE = "./josaa-fee-batch-03-safe.json";
const REVIEW = "./josaa-fee-batch-03-needs-review.json";
const AUDIT = "./josaa-fee-batch-03-audit.json";
...
console.log(
  "JOSAA BATCH 03 PRACTICAL AUDIT"
);
console.log(
  "========================================"
);
