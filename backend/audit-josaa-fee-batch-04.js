...
const INPUT = "./josaa-fee-batch-04-ready.json";
const SAFE = "./josaa-fee-batch-04-safe.json";
const REVIEW = "./josaa-fee-batch-04-needs-review.json";
const AUDIT = "./josaa-fee-batch-04-audit.json";
...
console.log(
  "JOSAA BATCH 04 PRACTICAL AUDIT"
);
console.log(
  "========================================"
);
