...
const INPUT = "./josaa-fee-batch-06-ready.json";
const SAFE = "./josaa-fee-batch-06-safe.json";
const REVIEW = "./josaa-fee-batch-06-needs-review.json";
const AUDIT = "./josaa-fee-batch-06-audit.json";
...
console.log(
  "JOSAA BATCH 06 PRACTICAL AUDIT"
);
console.log(
  "========================================"
);
