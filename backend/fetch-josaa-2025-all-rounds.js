...
function extractGridRows(
  ...
  if (
    ...
    throw new Error(
      `Round ${round}: result table parsed but zero rows were found.`
    );
  }
...
async function fetchRound(
  ...
  console.log(
    `FETCHING JOSAA 2025 ROUND ${round}`
  );
  ...
  */
  ...
  const htmlFile =
    `./josaa-2025-round-${round}-official.html`;
  ...
  const jsonFile =
    `./josaa-2025-round-${round}-official.json`;
...
fs.writeFileSync(
  './josaa-2025-all-rounds-audit.json',
  JSON.stringify(
    audit,
    null,
    2
...
if (
  ...
  fs.writeFileSync(
    './josaa-2025-duplicate-rows.json',
    JSON.stringify(
      duplicates,
      null,
      2
