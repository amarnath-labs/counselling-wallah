...
console.log(
  'APPLY JOSAA 2024 HISTORICAL BRANCHES'
);
...
try {
  ...
  */
  ...
  if (
    ...
    throw new Error(
      `Expected ${EXPECTED_BEFORE} branches before commit, found ${before.rows[0].branch_count}`
    );
  }
  ...
  */
  ...
  if (
    ...
    throw new Error(
      'One or more 2024 historical branches already exist. Commit aborted.'
    );
  }
  ...
  */
  ...
  if (
    ...
    throw new Error(
      `Expected ${EXPECTED_AFTER} branches in transaction, found ${during.rows[0].branch_count}`
    );
  }
  ...
  */
  ...
  if (
    ...
    throw new Error(
      `Post-commit branch count mismatch. Expected ${EXPECTED_AFTER}, got ${after.rows[0].branch_count}`
    );
  }


  fs.writeFileSync(
    './josaa-2024-historical-branches-committed.json',
    JSON.stringify(
      {
        committedAt:
          new Date()
  ...
  console.log(
    'JOSAA 2024 HISTORICAL BRANCH COMMIT PASSED'
  );
