...
const INPUT =
  path.resolve(
    './data/neet/mcc/2026/text/round-2.txt'
  );
...
function validateKnownRows(
   ...
   * Rank 1:
   *
   * AIIMS New Delhi in Round 1,
   * Reported,
   * no new Round-2 allotment,
   * Did not opt for Upgradation.
   */
   ...
   * Rank 9731:
   *
   * Probe showed fresh Round-2 allotment to
...
function run() {
  ...
  console.log(
    'NEET 2026 ROUND 2 PARSE COMPLETE'
  );
