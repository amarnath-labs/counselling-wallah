...
const INPUT = "./josaa-fee-batch-02-ready.json";
const SAFE = "./josaa-fee-batch-02-safe.json";
const REVIEW = "./josaa-fee-batch-02-needs-review.json";
const AUDIT = "./josaa-fee-batch-02-audit.json";
...
console.log(
  "JOSAA BATCH 02 PRACTICAL AUDIT"
);
console.log(
  "========================================"
);
