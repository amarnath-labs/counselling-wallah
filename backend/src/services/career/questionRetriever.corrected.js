...
export async function retrieveRankedQuestionCandidates({
  ...
  /*
  |--------------------------------------------------------------------------
  | Blend adaptive evidence + complete profile combination
  |--------------------------------------------------------------------------
  |
  | Existing ranker continues to control trait coverage, uncertainty,
  | career matches and previous-answer adaptation.
  |
  | Profile combination adds class, board, stream, subjects, exams,
  | interests, goal, degree, branch/specialization, skills and courses.
  |--------------------------------------------------------------------------
  */
