...
const INPUT = "./josaa-fee-batch-05-ready.json";
const SAFE = "./josaa-fee-batch-05-safe.json";
const REVIEW = "./josaa-fee-batch-05-needs-review.json";
const AUDIT = "./josaa-fee-batch-05-audit.json";
...
function audit(row) {
  ...
  */
  ...
  if (
    collegeName.includes("thanjavur") &&
    sourceUrl.includes("sonepat")
  ) {
    issues.push(
      "COLLEGE_IDENTITY_MISMATCH_THANJAVUR_VS_SONEPAT"
    );
  }
...
console.log(
  "JOSAA BATCH 05 PRACTICAL AUDIT"
);
console.log(
  "========================================"
);
