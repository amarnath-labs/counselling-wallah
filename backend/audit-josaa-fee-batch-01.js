...
const INPUT = "./josaa-fee-batch-01-ready.json";
const SAFE = "./josaa-fee-batch-01-safe.json";
const REVIEW = "./josaa-fee-batch-01-needs-review.json";
const AUDIT = "./josaa-fee-batch-01-audit.json";
...
function audit(row) {
  ...
  if (row.source_kind === "official") {
    ...
    issues.push(
      "WEAK_SECONDARY_SINGLE_FIELD_PAGE"
    );
  }
...
console.log(
  "JOSAA BATCH 01 PRACTICAL AUDIT"
);
console.log(
  "========================================"
);
