...
const INPUT = "./josaa-fee-batch-08-ready.json";
const SAFE = "./josaa-fee-batch-08-safe.json";
const REVIEW = "./josaa-fee-batch-08-needs-review.json";
const AUDIT = "./josaa-fee-batch-08-audit.json";
...
console.log(
  "JOSAA BATCH 08 PRACTICAL AUDIT"
);
console.log(
  "========================================"
);
