...
const INPUT =
  "./josaa-fee-review-22-research-queue.json";

const READY =
  "./josaa-fee-review-22-ready.json";

const REVIEW =
  "./josaa-fee-retry-01-review.json";

const REPORT =
  "./josaa-fee-review-22-report.json";
...
const noFeeCandidates = priorityQueue;
