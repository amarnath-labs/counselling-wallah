...
export function AppStateProvider({
  ...
  |--------------------------------------------------------------------------
  |
  | Keep the exact branch clicked on Results.
  | Branch array order can differ between recommendation results and the
  | unified college-detail API, so index alone is not a stable identifier.
  |--------------------------------------------------------------------------
  */
  ...
  const openCollege =
    (
      ...
      */
      ...
      /*
      |--------------------------------------------------------------------------
      | PRESERVE CLICKED BRANCH
      |--------------------------------------------------------------------------
      |
      | Save branch name in addition to its temporary array index.
      | CollegeDetail will resolve this name against its unified branch list.
      |--------------------------------------------------------------------------
      */
