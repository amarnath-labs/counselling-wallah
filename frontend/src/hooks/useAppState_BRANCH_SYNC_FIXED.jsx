  ...
  const openCollege =
    (
      ...
      */
      ...
      /*
      |--------------------------------------------------------------------------
      | PRESERVE CLICKED BRANCH NAME
      |--------------------------------------------------------------------------
      |
      | CollegeDetail may load the same college branches from another API
      | source and their array order can differ. Saving only the index can
      | therefore select the wrong branch. Keep the exact clicked branch name
      | as the stable selection key.
      |--------------------------------------------------------------------------
      */
