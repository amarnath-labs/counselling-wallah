...
export default function CareerDiscovery() {
  ...
  */
  ...
  async function requestNextQuestion(
    ...
    const response =
      await fetch(
        `${API_BASE_URL}/career/assessment/next-question`,
        {
          method: 'POST',
          headers: {
            'Content-Type':
  ...
  async function startAssessment() {
    ...
    try {
      ...
      if (
        ...
        throw new Error(
          'The adaptive assessment did not return a starting question.'
        );
      }
