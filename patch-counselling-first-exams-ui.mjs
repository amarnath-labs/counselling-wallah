...
const examsData =
  './frontend/src/data/exams.js';

fs.copyFileSync(
  examsPage,
  `${examsPage}.before-counselling-ui`
);

fs.copyFileSync(
  examsData,
  `${examsData}.before-counselling-ui`
);
...
const data = `// Demo/local exam catalog migrated from the prototype.

export const EXAMS = [
  {
    id: 'josaa',
    name: 'JoSAA',
    desc: 'Joint Seat Allocation Authority counselling for IITs, NITs, IIITs and GFTIs.',
    active: true,
  },
  {
    id: 'csab',
    name: 'CSAB',
    desc: 'Central Seat Allocation Board counselling for NIT+ system vacant seats.',
    active: true,
  },
  {
    id: 'mht-cet',
    name: 'MHT-CET',
    desc: "Maharashtra's state CET for engineering & pharmacy.",
    active: true,
  },
  {
    id: 'wbjee',
    name: 'WBJEE',
    desc: 'West Bengal state entrance for engineering colleges.',
    active: false,
  },
  {
    id: 'uptac',
    name: 'UPTAC',
    desc: 'Uttar Pradesh state counselling for engineering admissions.',
    active: true,
  },
  {
    id: 'cuet',
  ...
  },
  {
    id: 'comedk',
    name: 'COMEDK',
    desc: 'Karnataka private engineering college entrance.',
    active: false,
  },
  {
    id: 'bitsat',
    name: 'BITSAT',
    desc: 'Entrance for BITS Pilani campuses.',
    active: false,
  },
  {
    id: 'viteee',
    name: 'VITEEE',
    desc: 'Entrance for VIT campuses.',
    active: false,
  },
  {
    id: 'met',
    name: 'MET',
    desc: 'Manipal Entrance Test for Manipal group colleges.',
    active: false,
  },
  {
    id: 'srmjeee',
    name: 'SRMJEEE',
    desc: 'Entrance for SRM group of institutions.',
    active: false,
  },
];
`;
...
console.log(
  '✅ JEE Main top-level card removed'
);
console.log(
  '✅ JEE Advanced top-level card removed'
);
console.log(
  '✅ JoSAA counselling card added'
);
console.log(
  '✅ CSAB counselling card added'
);
console.log(
  '✅ JoSAA JEE Main / Advanced rank selector added'
);
console.log(
  '✅ CSAB JEE Main rank selector added'
);
console.log(
  '✅ Existing recommendation scoring untouched'
);
